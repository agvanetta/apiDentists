...
import (
	...
	"github.com/agvanetta/apiDentists/internal/domain"
...
func (r *repository) Delete(id int) error {
	...
	if err != nil {
		return errors.New("Error deleting a Patient  Cause 1:he have still turns. Cause 2: He doest exist.")
	}
	return nil
}
...
func unchangeEmptysPatient(patient domain.Patient, original domain.Patient) domain.Patient {
	...
	if patient.Domicile == "" {
		patient.Domicile = original.Domicile
	}
	if patient.DNI == "" {
